...
import { e as getFeaturedImage, g as getCategory, b as getAuthorName, c as getReadingTime } from './BlogFooter_CpeqppYU.mjs';

function BlogNewsletter() {
  return /* @__PURE__ */ jsx("section", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16", children: /* @__PURE__ */ jsx("div", { className: "rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-10 lg:p-12 shadow-xl", style: { background: "#0000FF" }, children: /* @__PURE__ */ jsxs("div", { className: "max-w-2xl mx-auto text-center", children: [
