...
import { h as getFeaturedImage, g as getCategory, c as getAuthorName, d as getReadingTime } from './BlogFooter_G1UqGiyZ.mjs';

function BlogNewsletter() {
  return /* @__PURE__ */ jsx("section", { className: "max-w-7xl mx-auto px-6 py-16", children: /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 rounded-2xl p-12 shadow-xl", children: /* @__PURE__ */ jsxs("div", { className: "max-w-2xl mx-auto text-center", children: [
    /* @__PURE__ */ jsx("div", { className: "flex justify-center mb-6", children: /* @__PURE__ */ jsx(Mail, { className: "text-yellow-400", size: 48 }) }),
    /* @__PURE__ */ jsx("h3", { className: "text-3xl font-bold text-white mb-4", children: "Get Infrastructure Insights Before Everyone Else" }),
    /* @__PURE__ */ jsx("p", { className: "text-blue-100 mb-8 text-lg", children: "Technical deep dives, case studies, and best practices delivered to your inbox. No spam, ever." }),
    /* @__PURE__ */ jsxs("div", { className: "flex gap-3 max-w-md mx-auto", children: [
      /* @__PURE__ */ jsx(
        "input",
        {
          type: "email",
