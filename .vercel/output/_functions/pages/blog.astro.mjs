...
import { h as getFeaturedImage, g as getCategory, c as getAuthorName, d as getReadingTime, B as BlogHeader, a as BlogFooter, f as fetchPosts, b as fetchCategories } from '../chunks/BlogFooter_BjTpjKYp.mjs';
import { A as ArticleCard, B as BlogNewsletter } from '../chunks/ArticleCard_D3reIGxt.mjs';
...
function BlogIndexPage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gray-50", style: { fontFamily: "'Inter', system-ui, sans-serif" }, children: [
    ...
    /* @__PURE__ */ jsxs("main", { children: [
      /* @__PURE__ */ jsx("section", { className: "relative bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 overflow-hidden", children: /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20 lg:py-24", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-4 sm:mb-6", children: "The Mailinfra Blog" }),
        /* @__PURE__ */ jsx("p", { className: "text-lg sm:text-xl md:text-2xl text-blue-100 font-medium mb-2 sm:mb-3", children: "Infrastructure Insights for Modern Email Teams" }),
        /* @__PURE__ */ jsx("p", { className: "text-base sm:text-lg text-blue-200 leading-relaxed", children: "Deep technical guides on deliverability, SMTP, scaling cold email infrastructure, and building reliable outbound systems." })
      ] }) }) }),
      loading ? /* @__PURE__ */ jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-16 text-center", children: /* @__PURE__ */ jsx("p", { className: "text-gray-600", children: "Loading articles..." }) }) : /* @__PURE__ */ jsxs(Fragment, { children: [
